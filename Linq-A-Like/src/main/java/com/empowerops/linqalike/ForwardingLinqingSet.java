 ...
 */
public final class ForwardingLinqingSet<TElement> implements Set<TElement>,
                                                             DefaultedQueryable<TElement> ,
                                                             WritableCollection<TElement>{

    private final Set<TElement> source;

    public ForwardingLinqingSet(Set<TElement> source){
        this.source = source;
    }
    ...
    @Override public final boolean removeIf(Predicate<? super TElement> filter) {
