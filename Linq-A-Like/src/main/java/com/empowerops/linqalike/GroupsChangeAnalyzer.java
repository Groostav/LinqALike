...
import static com.empowerops.common.BootstrappingUtilities.getEnvBool;
import static com.empowerops.common.BootstrappingUtilities.getEnvDouble;
...
public class GroupsChangeAnalyzer<TGroup, TMember>{
    ...
    private TGroup findWithPlusOrMinusSomeElements(Queryable<TMember> sourceMembers) {
        ...
        TGroup result = candidateDestinations.firstOrDefault(candidate -> {
    ...
    public static class GroupChangeSetCollection<TGroup, TMember> implements DefaultedQueryable<Change<TGroup, TMember>>{
        ...
        TGroupWrapper getGroupMatchingOrLogAsMissing(Func2<? super TGroupWrapper, ? super TGroup, Boolean> comparer,
            ...
            TGroupWrapper found = remainingGroups.firstOrDefault(group -> comparer.getFrom(group, change.source));
            if(found == null) {
    ...
    public static class Change<TGroup, TMember> {
        ...
        /*Visible for Testing*/ static <TMember>
        ...
        void applyTo(TMutableGroup groupToModify, WritableCollection<TMember> collectionToModify) {
            ...
            if (collectionToModify instanceof Set) {
                ...
                for (int index : range(0, destinationMembers.size())) {
                    ...
                    else if (index < actualCollectionToModify.size()) { actualCollectionToModify.set(index, member); }
                }
            }
            else {
