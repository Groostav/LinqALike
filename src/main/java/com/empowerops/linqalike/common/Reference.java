...
public class Reference<TReferenced> {
     ...
     *     <li>You have an EqualityComparator&lt;Vehicle&gt; that returns <tt>true</tt> if the two vehicles
     *     have the same number of doors.</li>
     *     <li>you want to create a Tuple&lt;Vehicle, Vehicle&gt;, with two cars, and the above equality comparator.</li>
     * </ul>
     *
